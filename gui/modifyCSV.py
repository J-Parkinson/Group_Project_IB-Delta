...
class RulesWindow(QWidget):
    ...
    def initUI(self):
        ...
        help_text = QLabel("This page allows you to split any existing columns in your notebook into new columns.\n"
                           ...
                           "-   just_first:                     only the first new column to use that index will have\n"
                           "                                    that word added\n"
                           "-   just_last:                      only the last new column to use that index will have\n"
                           "                                    that word added\n"
                           "-   all:                            clashes are ignored, so multiple new columns can refer\n"
                           "                                    to the same word\n\n"
                           "Usage example:\n"
