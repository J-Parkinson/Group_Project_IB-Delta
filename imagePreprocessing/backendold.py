...
def createCSVFile(pdfLocation, columnLocations = [], widthOfPreviewImage=1, noPageSpread=1):
    ...
    for x, page in enumerate(allImages):
        ...
        if (noPageSpread > 1):
            ...
            matrix_to_csv(wordsDecoded, 'test3.csv')
...
createCSVFile("..\imagePreprocessing\images\scantest2.pdf", columnLocations=[400, 848, 1805, 2239, 2678], widthOfPreviewImage=3122)
